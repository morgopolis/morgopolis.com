...
<div class="region">';
    ...
    <div id="wrapper" class="forum-container">
...
function template_body_below()
{
    ...
    //BSC - 07/22/2012 - removed the HTML and other validators.
	echo '
	<div id="footer_section"><div class="frame">
		<ul class="reset">
            <li class="copyright">Forum software by Simple Machines Forum</li>
...
//BSC - 12/04/2011 - making forums match the new theme - END
//BSC - 07/22/2012 - updating to match new theme
echo '
</div>
<div class="region">
    <div id="footer">&copy; Morgopolis Studios, LLC.  All rights reserved.</div>
</div>';
